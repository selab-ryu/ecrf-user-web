...
(
	property = {
		...
		"mvc.command.name=" + ECRFUserMVCCommand.ACTION_REDIRECT_CRF_QUERY
	},
	service = MVCActionCommand.class
)
public class RedirectQueryListActionCommand extends BaseMVCActionCommand{
	@Override
	protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		...
		renderURL.setParameter(ECRFUserWebKeys.MVC_RENDER_COMMAND_NAME, ECRFUserMVCCommand.RENDER_LIST_CRF_QUERY);
