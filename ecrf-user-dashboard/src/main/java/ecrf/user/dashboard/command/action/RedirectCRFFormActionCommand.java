...
(
	property = {
		...
		"mvc.command.name=" + ECRFUserMVCCommand.ACTION_REDIRECT_CRF_FORM,
	},
	service = MVCActionCommand.class
)
public class RedirectCRFFormActionCommand extends BaseMVCActionCommand{
	...
	private Log _log = LogFactoryUtil.getLog(RedirectCRFFormActionCommand.class);
}
