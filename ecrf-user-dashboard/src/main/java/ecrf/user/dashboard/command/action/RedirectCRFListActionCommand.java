...
(
	property = {
		...
		"mvc.command.name=" + ECRFUserMVCCommand.ACTION_REDIRECT_CRF_DATA_LIST,
	},
	service = MVCActionCommand.class
)
public class RedirectCRFListActionCommand extends BaseMVCActionCommand{
	...
	private Log _log = LogFactoryUtil.getLog(RedirectCRFListActionCommand.class);
}
