package ecrf.user.crf.query.command.action.redirect;
...
@Component(
    ...
    property = {
        ...
        "mvc.command.name="+ECRFUserMVCCommand.ACTION_MOVE_CRF_DATA
    },
    service = MVCActionCommand.class
)
public class MoveCRFDataActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		...
		String pageFriendlyURL = "/crf/data";
		String portletKey = ECRFUserPortletKeys.CRF_DATA;
