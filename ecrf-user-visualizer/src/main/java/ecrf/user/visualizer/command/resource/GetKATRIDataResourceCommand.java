...
@Component(
    ...
    property = {
            ...
            "mvc.command.name="+ECRFVisualizerMVCCommand.RESOURCE_GET_KATRI
    },
    service = MVCResourceCommand.class
)

public class GetKATRIDataResourceCommand extends BaseMVCResourceCommand {
	...
	private Log _log = LogFactoryUtil.getLog(GetKATRIDataResourceCommand.class);
