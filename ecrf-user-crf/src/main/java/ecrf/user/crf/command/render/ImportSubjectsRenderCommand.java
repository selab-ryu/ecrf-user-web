...
@Component(
	    ...
	    property = {
	        ...
	        "mvc.command.name="+ECRFUserMVCCommand.RENDER_IMPORT_SUBJECTS
	    },
	    service = MVCRenderCommand.class
	)
public class ImportSubjectsRenderCommand implements MVCRenderCommand{
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		return ECRFUserJspPaths.JSP_IMPORT_SUBJECTS;
	}
