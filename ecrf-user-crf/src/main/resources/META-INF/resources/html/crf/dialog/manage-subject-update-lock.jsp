	...
	<div class="">
		<aui:container cssClass="radius-shadow-container">
					...
					<table id="lockSubjectList" style="width:100%" class="table table-striped table-bordered">
						<thead>
							<tr>
								...
								<th><liferay-ui:message key="ecrf-user.list.serial-id"/></th>
			...
			<aui:button-row cssClass="div-center">
				<button id="<portlet:namespace/>addSubjectBtn" class="dh-icon-button submit-btn up-btn w120 h36" >
					<span><img class="up-icon marR8"/><liferay-ui:message key="ecrf-user.button.add"/></span>
				</button>
				
				<button id="<portlet:namespace/>removeSubjectBtn" class="dh-icon-button submit-btn down-btn w120 h36" >
...
$(document).ready( function() {
	...
	$('#<portlet:namespace/>closeDialog').on("click", function() {
		Liferay.Util.getOpener().closePopup('manageUpdateLockPopup', "close", null);
	});	
});
