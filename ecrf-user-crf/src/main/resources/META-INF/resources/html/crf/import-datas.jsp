...
<%!
    private static Log _log = LogFactoryUtil.getLog("html.crf.import_data_jsp");
%>
...
<liferay-portlet:actionURL name="<%=ECRFUserMVCCommand.ACTION_IMPORT_DATAS %>" var="importDatasJsonURL">
