...
import selab.ecrf.user.constants.ECRFUserMVCCommand;
import selab.ecrf.user.constants.ECRFUserPortletKeys;
import selab.ecrf.user.constants.ECRFUserResearcherAttributes;
import selab.ecrf.user.constants.ECRFUserWebKeys;
import selab.ecrf.user.model.Researcher;
