...
@Component(
	property = {
		...
		"mvc.command.name="+ECRFUserMVCCommand.RENDER_VIEW_SUBJECT
	},
	service=MVCRenderCommand.class
)
public class ViewSubjectRenderCommand implements MVCRenderCommand {
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		return ECRFUserJspPaths.JSP_VIEW_SUBJECT;
	}
